...
export function PlayerSettingsPanel({
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* 设置面板 */}
      {isOpen && (
        <div className="fixed sm:absolute inset-x-4 sm:inset-x-auto top-[60px] sm:top-auto sm:right-0 sm:mt-3 sm:w-80 md:w-96 max-h-[calc(100dvh-80px)] sm:max-h-[70vh] bg-gray-900/98 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-700 overflow-y-auto animate-fade-in z-[5000]">
          {/* 标题栏 */}
